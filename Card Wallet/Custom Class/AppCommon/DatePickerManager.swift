...
public typealias DatePickerDateCompletion = (_ date: Date?, _ cancel: Bool) -> Void
public typealias DatePickerValueIndexCompletion = (_ value: String?, _ index: Int, _ cancel: Bool) -> Void
...
open class DatePickerManager: NSObject, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    @objc open func showPicker(title: String?, selected: Date?, completion:DatePickerDateCompletion?) {
        ...
        self.showPicker(title: NSLocalizedString(title!, comment: ""), selected: selected, min: minDate, max: currentDate, completion: completion)
    }
    
    @objc open func showPicker(title: String?, selected: Date?, min: Date?, max: Date?, completion:DatePickerDateCompletion?) {
        self.showPicker(title: NSLocalizedString(title!, comment: ""), picker: { (picker) in
    ...
    @objc open func showPickerForTime(title: String?, selected: Date?, min: Date?, max: Date?, completion:DatePickerDateCompletion?) {
        self.showPicker(title: NSLocalizedString(title!, comment: ""), picker: { (picker) in
            picker.date = selected ?? Date()
            picker.minimumDate = min
            picker.maximumDate = max
    ...
    @objc open func showPicker(title: String?, selected: String?, strings:[String], completion:DatePickerValueIndexCompletion?) {
    ...
    @objc open func showPicker(title: String?, view: UIView, completion:DatePickerCompletion?) {
